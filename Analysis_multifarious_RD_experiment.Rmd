...
for (i in seq_along(nested_gams$gams)) {
  ...
  plot <- ggplot(rates %>% filter(species == species_name),
    ...
    scale_fill_gradientn(colors = RColorBrewer::brewer.pal(11, "Spectral"), limits = c(0, 1)) +
...
for (i in seq_along(combinations)) {
  ...
  temperature <- 20 + 1.5 * sin(2 * pi * time_points / 3)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 18), 28)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 23.5 + 1.5 * sin(2 * pi * time_points / 3)  # Fluctuation every 3 days
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 26.5 + 1.5 * sin(2 * pi * time_points / 3)  # Fluctuation every 3 days
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 19 + 1 * sin(2 * pi * time_points / 3)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 18), 28)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 23 + 1 * sin(2 * pi * time_points / 3)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 22), 26)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 27 + 1 * sin(2 * pi * time_points / 3)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 24), 28)  # Ensure temperature stays between 18 and 22
...
Same temperature fluctuations as before, but now fluctuating over 4 days
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 20 + 2 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 24 + 2 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 22), 26)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 26 + 2 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 24), 28)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 20 + 1.5 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 18), 28)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 23.5 + 1.5 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 22), 26)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 26.5 + 1.5 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 24), 28)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 19 + 1 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 18), 28)  # Ensure temperature stays between 18 and 22
...
for (i in seq_along(combinations)) {
  # Simulate temperature (fluctuating by +/- 2 degrees every 3 days)
  temperature <- 23 + 1 * sin(2 * pi * time_points / 4)  # Fluctuation every 3 days
  temperature <- pmin(pmax(temperature, 22), 26)  # Ensure temperature stays between 18 and 22
