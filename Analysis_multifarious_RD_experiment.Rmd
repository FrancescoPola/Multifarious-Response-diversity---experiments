...
```{r results='asis', message=FALSE, warning=FALSE}
## Display the parameter table
DT::datatable(final_result_2species,
              filter="top")
```
...
```{r results='asis', message=FALSE, warning=FALSE}
## Display the parameter table
DT::datatable(result_list_3species,
              filter="top")
```
...
```{r results='asis', message=FALSE, warning=FALSE}
## Display the parameter table
DT::datatable(result_list_4species,
              filter="top")
```
...
<!-- ```{r results='asis', message=FALSE, warning=FALSE} -->
<!-- ## Display the parameter table -->
<!-- DT::datatable(ranked_potential_RD_df, -->
<!--               filter="top") -->
<!-- ``` -->
