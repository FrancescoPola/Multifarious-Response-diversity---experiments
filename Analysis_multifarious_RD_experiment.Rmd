...
temperature_pattern <- c(rep(18, 3), 20, rep(22, 3))
...
# Set temperature values based on the description
temperature_pattern <- c(rep(22, 3), 24, rep(26, 3))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(24, 3), 26, rep(28, 3))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(18, 3), 19, rep(20, 3))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(22, 3), 23, rep(24, 3))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(26, 3), 27, rep(28, 3))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(18, 5), 20, rep(22, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(22, 5), 24, rep(26, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(24, 5), 26, rep(28, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(18, 5), 19.5, rep(21, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(22, 5), 23.5, rep(25, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(25, 5), 26.5, rep(28, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(18, 5), 19, rep(20, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(22, 5), 23, rep(24, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
# Set temperature values based on the description
temperature_pattern <- c(rep(26, 5), 27, rep(28, 5))
temperature_pattern <- rep(temperature_pattern, length.out = total_days)
...
```{r}
unique_values_total_df <- df_total %>%
  distinct(treatment, composition, dissimilarity, divergence, .keep_all = TRUE)

mag_1 %>% filter(richness == 2) %>% 
  ggplot(aes(x = treatment, y = divergence)) +
  geom_point(size = 1.5) +
  geom_text(aes(label = composition), vjust = -0.5, size = 4) +
  theme_bw() 
