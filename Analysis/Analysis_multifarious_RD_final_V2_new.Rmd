...
df_slopes<-df_slopes%>%mutate(nutrients=paste0(nutrients," g/L"),
 ...
 write.csv(df_slopes,"df_slopes_cor.csv",quote=F,row.names = F)
...
write_csv(selection_div,file="divergence_df.csv")
